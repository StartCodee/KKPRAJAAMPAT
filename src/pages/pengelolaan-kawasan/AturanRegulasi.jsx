  ...
  const legalData = {
    Nasional: [
      ...
      },
      {
        ...
        desc: "Peraturan ini mendefinisikan KKP sebagai â€œupaya perlindungan, pelestarian, dan pemanfaatan wilayah pesisir dan pulau-pulau kecil serta ekosistemnya untuk menjamin keberadaan, ketersediaan, dan kesinambungan sumber daya pesisir dan pulau-pulau kecil dengan tetap memelihara dan meningkatkan kualitas nilai dan keanekaragamannya.â€",
        ...
        <div className="bg-[#194484]/80 rounded-xl p-10 text-gray-200 space-y-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <AnimatePresence mode="wait">
              {legalData[activeTab].map((item, idx) => (
                <motion.div
